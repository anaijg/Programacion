...
public class Ejercicio35DoWhile {
    public static void main(String[] args) {
        ...
        do  { // si el primer número introducido es 0, nunca entraría en el bucle, lo cual es perfecto en este caso
            if (n != 0) { // tengo que meter este if porque si el primer número introducido es 0 no quiero que me pida un número
                n = teclado.nextInt();
            }
